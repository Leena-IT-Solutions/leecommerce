        ...
        <div class="menu-content">
            ...
            <div class="accordion" id="accordionExample">
                ...
                @if(Auth::user()->roles()->where('role', 'Web-Admin')->exists())
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <a href="/administrator/purchase" class="btn accordion-button collapsed no-caret {{ (request()->is('administrator/purchase')) ? 'active-link' : '' }}" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <a href="/administrator/offers" class="btn accordion-button collapsed no-caret {{ (request()->is('administrator/offers')) ? 'active-link' : '' }}" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseProductsManager" class="accordion-collapse collapse {{ (request()->is('administrator/products*')) ? 'show' : '' }}" aria-labelledby="headingProductsManager" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <ul class="list-group list-group-flush d-grid p-0">
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/products/category')) ? 'fw-bold' : '' }}" href="/administrator/products/category">Category</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/products/sub_category')) ? 'fw-bold' : '' }}" href="/administrator/products/sub_category">Sub Category</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/products/product_group')) ? 'fw-bold' : '' }}" href="/administrator/products/product_group">Product Group</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                @if(Auth::user()->roles()->where('role', 'Administrator')->exists())
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseReports" class="accordion-collapse collapse {{ (request()->is('administrator/reports*')) ? 'show' : '' }}" aria-labelledby="headingReports" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <ul class="list-group list-group-flush d-grid p-0">
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/reports/purchase')) ? 'fw-bold' : '' }}" href="/administrator/reports/purchase">Purchase</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/reports/sale')) ? 'fw-bold' : '' }}" href="/administrator/reports/sale">Sale</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/reports/invoices')) ? 'fw-bold' : '' }}" href="/administrator/reports/invoices">Invoices Wise Sale</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/reports/products')) ? 'fw-bold' : '' }}" href="/administrator/reports/products">Product Wise Sale</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingAnalytics">
                            <button class="accordion-button {{ (request()->is('administrator/analytics*')) ? '' : 'collapsed' }}" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAnalytics" aria-expanded="true" aria-controls="collapseAnalytics">
                        ...
                        <div id="collapseAnalytics" class="accordion-collapse collapse {{ (request()->is('administrator/analytics*')) ? 'show' : '' }}" aria-labelledby="headingAnalytics" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <ul class="list-group list-group-flush d-grid p-0">
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/orders')) ? 'fw-bold' : '' }}" href="/administrator/analytics/orders">Orders</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/sale')) ? 'fw-bold' : '' }}" href="/administrator/analytics/sale">Sale</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/purchase')) ? 'fw-bold' : '' }}" href="/administrator/analytics/purchase">Purchase</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/customers')) ? 'fw-bold' : '' }}" href="/administrator/analytics/customers">Customers</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/category')) ? 'fw-bold' : '' }}" href="/administrator/analytics/category">Category</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/sub_category')) ? 'fw-bold' : '' }}" href="/administrator/analytics/sub_category">Sub_category</a></li>
                                    <li class="list-group-item"><a class="btn btn-sm btn-default btn-full border-0 {{ (request()->is('administrator/analytics/product')) ? 'fw-bold' : '' }}" href="/administrator/analytics/product">Product</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <a href="/administrator/user_manager" class="btn accordion-button collapsed no-caret {{ (request()->is('administrator/user_manager')) ? 'active-link' : '' }}" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">
                    ...
                    @if(Auth::user()->roles()->where('role', 'Web-Admin')->exists())
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <a href="/administrator/theme" class="btn accordion-button collapsed no-caret {{ (request()->is('administrator/theme')) ? 'active-link' : '' }}" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">
                                    <i class="fas fa-fw fa-palette mr-2"></i>
                                    Theme Manager
                                </a>
                            </h2>
                        </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <a href="/administrator/settings" class="btn accordion-button collapsed no-caret {{ (request()->is('administrator/settings')) ? 'active-link' : '' }}" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">
